...
- The `survey_results_schema.csv` file contains each column name from the main results along with the question text corresponding to that column. This (huge) excerpt below provides a snapshot into it:
...
As the snapshot below shows, most of the data was previously curated.
